...
def is_east_or_west_lane(lid):
    accepted_lids = [LEFT_UP, LEFT_MID, LEFT_DOWN]

    if lid in accepted_lids:
        return True

    # If not east/west, randomly select nort/south
